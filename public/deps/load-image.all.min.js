!(function (c) {
    ...
    function t(i, a) {
      ...
      function e(e, t) {
        t && c.console && console.log(t),
          e && g('Blob', e) ? (n = f((s = e))) : ((n = s), l && l.crossOrigin && (r.crossOrigin = l.crossOrigin)),
          (r.src = n)
      }
      return (
  ...
  (function (e) {
    ...
    ;(E.createCanvas = function (e, t, i) {
      ...
      (E.getTransformedOptions = function (e, t) {
        ...
        return (
          (i.crop = !0),
          r < (n = e.naturalWidth || e.width) / (e = e.naturalHeight || e.height)
      ...
      (E.drawImage = function (e, t, i, a, n, r, o, s, l) {
        ...
        return (
          !1 === l.imageSmoothingEnabled
            ...
            : l.imageSmoothingQuality && (t.imageSmoothingQuality = l.imageSmoothingQuality),
      ...
      (E.scale = function (e, t, i) {
        ...
        var a,
          ...
          d,
          g,
          m = e.getContext || (E.requiresCanvas(t) && !!E.global.HTMLCanvasElement),
        ...
        if (
          (m &&
            ...
            (f = t.top || 0),
            t.sourceWidth
              ? ((s = t.sourceWidth), t.right !== undefined && t.left === undefined && (c = h - s - t.right))
              : (s = h - c - (t.right || 0)),
            t.sourceHeight
              ? ((l = t.sourceHeight), t.bottom !== undefined && t.top === undefined && (f = p - l - t.bottom))
              : (l = p - f - (t.bottom || 0)),
            (A = s),
            (b = l)),
          (a = t.maxWidth),
          ...
          m && a && n && t.crop
            ? (d = s / l - (A = a) / (b = n)) < 0
              ? ((l = (n * s) / a), t.top === undefined && t.bottom === undefined && (f = (p - l) / 2))
              : 0 < d && ((s = (a * l) / n), t.left === undefined && t.right === undefined && (c = (h - s) / 2))
            : ((t.contain || t.cover) && ((r = a = a || r), (o = n = n || o)), t.cover ? (S(), y()) : (y(), S())),
          m)
        ) {
          if (
            (1 < (m = t.pixelRatio) &&
              (!e.style.width || Math.floor(parseFloat(e.style.width, 10)) !== Math.floor(h / m)) &&
              ((A *= m), (b *= m)),
            E.orientationCropBug &&
              !e.getContext &&
              (c || f || s !== h || l !== p) &&
              ((d = e), (e = E.createCanvas(h, p, !0)), E.drawImage(d, e, 0, 0, h, p, h, p, t)),
  ...
  (function (e) {
    ...
    function c(t, e, u, d) {
        ...
        o.readFile(
          ...
          function (e) {
            ...
            for (
              ...
              o < s && ((65504 <= (i = t.getUint16(o)) && i <= 65519) || 65534 === i);
      ...
      return (
        (u = u || {}),
        s.Promise && 'function' != typeof e ? ((d = u = e || {}), new Promise(i)) : ((d = d || {}), i(e, e))
      )
    }
    function n(e, t, i) {
    ...
    ;(t = f).global.document &&
      (((i = document.createElement('img')).onload = function () {
        ...
        ;(t.orientation = 2 === i.width && 3 === i.height),
          t.orientation &&
            ((e = t.createCanvas(1, 1, !0).getContext('2d')).drawImage(i, 1, 1, 1, 1, 0, 0, 1, 1),
          ...
          function (e, t) {
            ...
            !t ||
              (4 < (a = f.orientation && t.exif && t.exif.get('Orientation')) &&
                a < 9 &&
                ((i = t.originalWidth), (a = t.originalHeight), (t.originalWidth = a), (t.originalHeight = i))),
              n(e, t)
          },
          i,
          a
      ...
      (f.transformCoordinates = function (e, t, i) {
        ...
        if (d(t, i)) {
          var a = e.getContext('2d'),
            ...
            s = r
          switch (
            (((4 < t && !(4 < i)) || (t < 5 && 4 < i)) && ((e.width = r), (e.height = n)),
            4 < t && ((o = r), (s = n)),
            i)
          ) {
            case 2:
          ...
          if (1165519206 === l.getUint32(e + 4))
            if (g + 8 > l.byteLength) console.log('Invalid Exif data: Invalid segment size.')
              ...
              42 === l.getUint16(g + 2, f)
                ? ((e = l.getUint32(g + 4, f)),
                  (c.exif = new m()),
                  i.disableExifOffsets || ((c.exifOffsets = new m()), (c.exifTiffOffset = g), (c.exifLittleEndian = f)),
                  (e = A(l, g, g + e, f, c.exif, c.exifOffsets, u, d)) &&
                    p(u, d, 'ifd1') &&
                    ((c.exif.ifd1 = e), c.exifOffsets && (c.exifOffsets.ifd1 = g + e)),
                  Object.keys(c.exif.ifds).forEach(function (e) {
                    ...
                    ;(i = e),
                      ...
                      (e = (t = c).exif[i]) &&
                        ...
                        A(a, n, n + e, r, t.exif[i], t.exifOffsets && t.exifOffsets[i], o && o[i], s && s[i]))
                  }),
                  (e = c.exif.ifd1) &&
                    e[513] &&
                    (e[513] = (function (e, t, i) {
                      if (i) {
                        if (!(t + i > e.byteLength))
                          return new Blob([n.bufferSlice.call(e.buffer, t, t + i)], { type: 'image/jpeg' })
      ...
      for (var o, s, l, c = t + i, f = t; f < c; )
        28 === e.getUint8(f) &&
          ...
          (n && !n[o]) ||
            ...
            (a.iptc[o] =
              ((s = a.iptc[o]), (l = l), s === undefined ? l : s instanceof Array ? (s.push(l), s) : [s, l])),
            a.iptcOffsets && (a.iptcOffsets[o] = f))),
          (f += 1)
    }
    ;(l.prototype.map = { ObjectName: 5 }),
      (l.prototype.types = { 0: 'Uint16', 200: 'Uint16', 201: 'Uint16', 202: 'binary' }),
          ...
          for (var r = t + i; t + 8 < r; ) {
            if (((o = t), 943868237 === (s = e).getUint32(o) && 1028 === s.getUint16(o + 4))) {
              ...
              return (
                ...
                void c(e, s, o, a, n.includeIptcTags, n.excludeIptcTags || { 202: !0 })
              )
            }
            t += 1
          }
