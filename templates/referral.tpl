...
You have been invited to join {{CONFIG['SITE_NAME']}} and have specified this address ({{Email}}) as your email address.

Please note that selling invites, trading invites, and giving invites away publicly (e.g. on a forum) is strictly forbidden.

If you had previously had an account at {{CONFIG['SITE_NAME']}}, do not use this invite. Instead, please join {{DISABLED_CHAN}} on {{IRC_SERVER}} and ask for your account to be reactivated.

To confirm your invite, click on the following link:

{{CONFIG['SITE_URL']}}/register.php?invite={{InviteKey}}
