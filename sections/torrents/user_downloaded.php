    ...
    <?    } else { ?>
        ...
        <table class="TableTorrent Table">
            <tr class="Table-rowHeader">
                <td class="Table-cell"><a href="<?= header_link('Name', 'ASC') ?>"><?= Lang::get('torrents', 'torrent') ?></a></td>
                <td class="Table-cell">
                    <i data-tooltip="<?= Lang::get('torrents', 'size') ?>">
                        <?= icon("torrent-size") ?>
                    </i>
                </td>
                <td class="Table-cell TableTorrent-cellStat">
                    <i data-tooltip="<?= Lang::get('global', 'uploaded') ?>">
                        <?= icon("uploaded") ?>
                    </i>
                </td>
                <td class="Table-cell TableTorrent-cellStat">
                    <i data-tooltip="<?= Lang::get('global', 'downloaded') ?>">
                        <?= icon("downloaded") ?>
                    </i>
                </td>
                <td class="Table-cell TableTorrent-cellStat">
                    <i data-tooltip="<?= Lang::get('global', 'ratio') ?>">
                        <?= icon("ratio") ?>
                    </i>
                </td>
                <td class="Table-cell TableTorrent-cellStat">
                    <a href="<?= header_link('Seeders') ?>">
                        <i aria-hidden="true" alt="Seeders" data-tooltip="<?= Lang::get('torrents', 'seeders') ?>">
                ...
                <td class="Table-cell TableTorrent-cellStat">
                    <a href="<?= header_link('Leechers') ?>">
                        <i aria-hidden="true" alt="Leechers" data-tooltip="<?= Lang::get('torrents', 'leechers') ?>">
                            <?= icon("torrent-leechers") ?>
                        </i>
                    </a>
                </td>
                <td class="center">
                    <i data-tooltip="<?= Lang::get('torrents', 'seeding_status') ?>">
                        <?= icon("seed-status") ?>
                    </i>
                </td>
                <td class="center">
                    <i data-tooltip="<?= Lang::get('torrents', 'seeding_time') ?>">
                        <?= icon("torrent-time") ?>
                    </i>
                </td>
                <? if (ENABLE_HNR) { ?>
            ...
            foreach ($TorrentsInfo as $TorrentID => $Info) {
                ...
                $Size = $Torrent['Size'];
                $TorrentName = Torrents::torrent_name($Torrent);
            ...
            ?>
                <tr class="Table-row">
                    ...
                    <td class="Table-cell Table-cellCenter">
                        <span class="u-colorSuccess"><?= $Seeding ? Lang::get('torrents', 'yes') : Lang::get('torrents', 'no') ?></span>
                    </td>
                    <td class="Table-cell Table-cellCenter">
