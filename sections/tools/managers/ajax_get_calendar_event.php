...
<form id="event_form" name="event_form" method="post" action="">
    ...
    <table class="event_form_table">
        ...
        <tr>
            ...
            <td>
                <input class="Input required" type="text" id="title" name="title" value="<?= $Event['Title'] ?>" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                <select class="Input" id="category" name="category" class="required">
                    ...
                    ?>
                        <option class="Select-option" value="<?= $Key ?>" <?= $Key == $Event['Category'] ? ' selected="selected"' : '' ?>><?= $Value ?></option>
                    <?  } ?>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <select class="Input" id="importance" name="importance" class="required">
                    <?
                    $Importances = Calendar::$Importances;
                    foreach ($Importances as $Key => $Value) {
                    ?>
                        <option class="Select-option" value="<?= $Key ?>" <?= $Key == $Event['Importance'] ? ' selected="selected"' : '' ?>><?= $Value ?></option>
                    <?  } ?>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <select class="Input" id="team" name="team" class="required">
                    <?
                    $Teams = Calendar::$Teams;
                    foreach ($Teams as $Key => $Value) {
                    ?>
                        <option class="Select-option" value="<?= $Key ?>" <?= $Key == $Event['Team'] ? ' selected="selected"' : '' ?>><?= $Value ?></option>
                    <?  } ?>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input class="Input required" type="date" id="start_date" name="start_date" <? if ($Event) { ?> value="<?= date('Y-m-d', strtotime($Event['StartDate'])) ?>" />
            <?  } else { ?>
                value="<?= $StartDate ?>" />
            <?  } ?>
            </td>
        ...
        <tr>
            ...
            <td>
                <input class="Input required" type="date" id="end_date" name="end_date" <? if ($Event) { ?> value="<?= date('Y-m-d', strtotime($Event['EndDate'])) ?>" />
            <?  } else { ?>
                value="<?= $EndDate ?>" />
            <?  } ?>
            </td>
        ...
        <tr>
            <td colspan="2">
                <textarea class="Input" id="body" name="body" class="required"><?= $Event['Body'] ?></textarea>
            </td>
        </tr>
        <tr>
            <?
            ...
            ?>
                    ...
                    <td>
                        <input class="Button" type="submit" id="delete" name="delete" value="Delete" />
                    </td>
                <?      } else { ?>
                    <td>
