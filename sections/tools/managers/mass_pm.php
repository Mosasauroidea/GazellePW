...
<div class="LayoutBody">
    <div class="BodyHeader">
        <h2 class="BodyHeader-nav"><?= Lang::get('tools.send_a_mass_pm') ?></h2>
    </div>
        ...
        <div class="BoxBody">
            ...
            <div id="quickpost">
                ...
                <select class="Input" id="class_id" name="class_id">
                    ...
                    <option class="Select-option" value="99"><?= Lang::get('tools.all_users') ?></option>
                    <option class="Select-option" value="100"><?= Lang::get('tools.staff') ?></option>
