...
<table class="Table">
        ...
        <tr class="Table-row">
            <form class="manage_form" name="accounts" action="" method="post">
                ...
                <td class="Table-cell">
                    ...
                    <input class="Button" type="submit" name="submit" value="Delete" onclick="return confirm('<?= t('server.tools.sure_delete_staff_group_title') ?>')" />
                </td>
            </form>
        </tr>
    <?php
    ...
    ?>
    <tr class="Table-rowHeader">
        <td class="Table-cell" colspan="3"><?= t('server.tools.create_group') ?></td>
    </tr>
    <tr class="Table-row">
