...
<div id="email_blacklist_manager">
    <form action="tools.php" method="post">
        ...
        <input class="Input" type="email" name="email" size="30" placeholder="<?= t('server.tools.email') ?>" />
        <input class="Input" type="text" name="comment" size="60" placeholder="<?= t('server.tools.email_blacklist_comment') ?>" />
    ...
    <table class="Table">
        ...
        <tr class="Table-rowHeader">
            <td class="Table-cell" colspan="4"><?= t('server.tools.add_to_blacklist') ?></td>
        </tr>
        <tr class="Table-row">
