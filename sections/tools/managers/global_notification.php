...
<h2><?= t('server.tools.set_global_notification') ?></h2>
...
<div class="thin BoxBody">
    <form action="tools.php" method="post">
        ...
        <table align="center">
            ...
            <tr>
                <td class="label"><?= t('server.tools.length_in_min') ?>:</td>
                <td>
