...
<div class="BodyHeader">
    <h2 class="BodyHeader-nav">Database Encryption Key</h2>
</div>
<div class="thin BoxBody">
    ...
    <form class="create_form" name="db_key" method="post" action="">
        <div class="pad">
            ...
            <input class="Input" type="text" name="dbkey" /> <br />
            <div class="center">
                <input class="Button" type="submit" name="submit" value="Update Key" />
            </div>
        </div>
    </form>
</div>
