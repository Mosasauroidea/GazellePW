...
<div class="BodyHeader">
    <h2 class="BodyHeader-nav">Referral Sandbox</h2>
</div>
<?php if ($hasResult) { ?>
        ...
        <table class="layout">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <textarea class="Input" name="cookie" cols="90" rows="8"><?= json_encode($cookie) ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="label">
                    ...
                    <td>
                        <textarea class="Input" name="params" cols="90" rows="8"><?= json_encode($params) ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="label">
...
<div class="thin BoxBody">
    <?php if ($referralManager->readOnly) { ?>
        <p>
            <strong class="u-colorWarning">DB key not loaded - accounts disabled</strong>
        </p>
