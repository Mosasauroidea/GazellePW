...
<div class="LayoutBody">
    ...
    <div class="BodyContent">
        ...
        ?>
        <div class="Box">
            <div class="Box-header"> <?= Lang::get('global', 'rules') ?> </div>
            <div class="Box-body"> <?= Lang::get('subtitles', 'subtitle_rules') ?> </div>
        </div>
    </div>
    ...
    ?>
        ...
        <div id="subtitle_upload_form_container" class="TableContainer">
            <form id="subtitle_upload_form" action="subtitles.php" method='post' enctype="multipart/form-data" accept-charset='UTF-8'>
                ...
                <td ><input class="Input" type="text" name="source" placeholder="<?= Lang::get('subtitles', 'a_subtitle_group') ?>"></td>
            </tr> -->
                    <!-- <tr>
                        ...
                        <tr class="TableSubtitle-row Table-row">
                            ...
                            <td class="TableSubtitle-cellName Table-cell">
                                <span class="floatright">
                                    ...
                                    <span> | </span>
                                    <a href="reportsv2.php?action=report&type=subtitle_track_bad&id=<?= $TorrentID ?>" data-tooltip="<?= Lang::get('global', 'report') ?>">RP</a>
