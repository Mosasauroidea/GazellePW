...
View::show_header('Recovery pair users', '', 'PageRecoveryPair');
?>
    ...
    ?>
        <div class="box">
            ...
            <form method="post" action="/recovery.php?action=pair">
                <p>Please confirm the following pairing:
                <p>
                <table>
                    <tr>
                        <th></th>
                    ...
                    <tr>
                        <td colspan="3"><input class="Button" type="submit" value="Confirm" /></td>
                    </tr>
        ...
        <div class="pad">
            <form method="post" action="/recovery.php?action=pair">
                <table>
                    ...
                    <tr>
                        <th>Previous ID</th>
                        <td><input class="Input" type="text" name="prev" width="10" value="<?= isset($prev_id) ? $prev_id : '' ?>" /></td>
                    </tr>
                </table>
                <input class="Button" type="submit" value="Pair" />
            </form>
        </div>
    </div>
    <?php
