...
View::show_header('Recovery administration', '', 'PageRecoveryAdmin');
...
<div class="LayoutBody">
    ...
    <form method="post" action="/recovery.php?action=admin">
        <table>
            <tr>
                <th>Token</th>
                <td><input class="Input" type="text" width="30" name="token" /></td>
                <th>Username</th>
                <td><input class="Input" type="text" width="30" name="username" /></td>
            </tr>
            <tr>
                <th>Announce</th>
                <td><input class="Input" type="text" width="30" name="announce" /></td>
                <th>Email</th>
                <td><input class="Input" type="text" width="30" name="email" /></td>
            </tr>
            <tr>
                <td></td>
                <td colspan="3"><input class="Button" type="submit" value="Search" /></td>
            </tr>
        </table>
