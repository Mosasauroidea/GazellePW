...
<form enctype="multipart/form-data" method="post" action="/recovery.php?action=save">
    ...
    <input class="Input" type="text" name="announce" />
    ...
    <textarea class="Input" rows="8" columns="80" name="invite"></textarea>
    ...
    <textarea class="Input" rows="4" columns="80" name="info"></textarea>
