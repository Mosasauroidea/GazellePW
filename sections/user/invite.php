...
*/
    ...
    if (
        ...
        <div class="BoxBody HtmlText" id="invite_rules_container">
            ...
            <br>
            <strong class="u-colorWarning"><?= t('server.user.invite_rules_6') ?></strong><br>
            <br><?= t('server.user.invite_rules_7') ?>
        </div>
        <div class="box box2">
            <form class="send_form pad" name="invite" action="user.php" method="post">
                ...
                <div class="field_div">
                    <div class="label"><?= t('server.user.email_address') ?>:</div>
                    <div class="input">
                ...
                <? if (check_perms('users_invite_notes')) { ?>
                    <div class="field_div">
                        <div class="label"><?= t('server.user.invite_note') ?>:</div>
                        <div class="input">
    ...
    <? } ?>
    <? if (!empty($Pending)) { ?>
        <h3 id="pending_invites_header"><?= t('server.user.pending_invites') ?></h3>
    ...
    <? } ?>
    <h3 id="invite_table_header"><?= t('server.user.invitee_list') ?></h3>
