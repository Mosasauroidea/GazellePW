...
<div class="LayoutBody">
    <form class="Form SearchPage Box SearchUserAdvanced is-fullWidth" name="users" action="user.php" method="get">
        ...
        <table class="Form-rowList">
            ...
            <tr class="Form-row">
                <td class="Form-label"><?= t('server.user.email_address') ?>:</td>
                <td class="Form-inputs">
                ...
                <td class="Form-label"><?= t('server.user.primary_class') ?>:</td>
                <td class="Form-inputs">
            ...
            <tr class="Form-row">
                ...
                <td class="Form-label"><?= t('server.user.locked_account') ?>:</td>
                <td class="Form-inputs">
                ...
                <td class="Form-label"><?= t('server.user.secondary_class') ?>:</td>
                <td class="Form-inputs">
            ...
            <tr class="Form-row">
                ...
                <td class="Form-inputs">
                    <ul class="options_list nobullet">
                        <li data-tooltip="<?= t('server.user.disabled_accounts_linked_by_ip_title') ?>">
                            <div class="Checkbox">
            ...
            <tr class="Form-row">
                <td class="Form-label"><?= t('server.user.disabled_invites') ?>:</td>
                <td class="Form-inputs">
                ...
                <td class="Form-label"><?= t('server.user.disabled_privilege') ?>:</td>
                <td class="Form-inputs">
            ...
            <tr class="Form-row">
                ...
                <td class="Form-label"><?= t('server.user.warned') ?>:</td>
                <td class="Form-inputs">
            ...
            <tr class="Form-row">
                <td class="Form-label"><?= t('server.user.passkey') ?>:</td>
                <td class="Form-inputs">
            ...
            <tr class="Form-row">
                <td class="Form-label"><?= t('server.user.tracker_ip') ?>:</td>
                <td class="Form-inputs">
            ...
            <tr class="Form-row">
                <td class="Form-submit" colspan="6">
...
<div class="BoxBody center" id="user_search_results_box">
    <h2><?= number_format($NumResults) ?><?= t('server.user.space_results') ?></h2>
