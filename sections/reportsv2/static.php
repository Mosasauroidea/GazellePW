                ...
                ?>
                    <div id="report<?= $ReportID ?>">
                        <h3><strong>#<?= $Idx + 1 ?></strong>
                            <span class="floatright" data-tooltip="<?= t('server.reportsv2.multi_resolve_title') ?>">
                                <input type="checkbox" name="multi" id="multi<?= $ReportID ?>" />&nbsp;<label for="multi"><?= t('server.reportsv2.multi_resolve') ?></label>
                            </span>
                            <?
                            if (!$GroupID) {
                            ?>
                                ...
                                <? if ($Status != 'Resolved') { ?>
                                    ...
                                    <tr class="Form-row">
                                        ...
                                        <td class="Form-inputs">
                                            ...
                                            <div><strong><?= t('server.reportsv2.extra') ?></strong><?= t('server.reportsv2.space_staff_notes') ?>:</div>
                                            <div>
