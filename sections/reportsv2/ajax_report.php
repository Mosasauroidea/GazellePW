...
?>
    <?= t('server.reportsv2.image_s') ?><?= ($ReportType['report_fields']['image'] == '1' ? ' <strong class="u-colorWarning">(' . t('server.reportsv2.required') . ')</strong>' : '') ?>:
