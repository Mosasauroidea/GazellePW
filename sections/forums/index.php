...
G::$Router->addGet('', SERVER_ROOT . '/sections/forums/browse.php');
...
G::$Router->addPost('edit_rules', SERVER_ROOT . '/sections/forums/edit_rules.php');
...
G::$Router->addGet('ajax_get_jf', SERVER_ROOT . '/sections/forums/ajax_get_jf.php');
