...
<div class="LayoutBody">
    <div class="TableContainer">
        <table id="custom-title-setting">
            <thead>
                <tr>
                    <td><?= t('server.bonus.custom_title') ?>, <?= ($BBCode === 'true') ? t('server.bonus.custom_title') : t('server.bonus.no_bbcode_allowed') ?> - <?= number_format($Price) ?> <?= t('server.bonus.custom_title') ?></td>
                </tr>
            </thead>
            <tbody>
                <tr>
