...
<div class="LayoutBody">
    <div class="BodyHeader">
        ...
        <div class="BodyNavLinks">
            ...
            if ($NumResults) {
            ?>
                <a href="#" onclick="Collapse(); return false;" id="collapselink" class="brackets"><?= $ShowCollapsed ? t('server.userhistory.show') : t('server.userhistory.hide') ?><?= t('server.userhistory.post_bodies') ?></a>
            <?
            }
            ?>
    ...
    ?>
        ...
        foreach ($Results as $Result) {
            switch ($Result['Page']) {
                case 'artist':
                    $Links = t('server.userhistory.artist') . ': <a href="artist.php?id=' . $Result['PageID'] . '">' . display_str($Result['Name']) . '</a>';
