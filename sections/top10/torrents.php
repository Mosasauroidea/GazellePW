...
<div class="LayoutBody">
    ...
    if ($Details == 'all' || $Details == 'day') {
        ...
        generate_torrent_table(Lang::get('top10', 'in_the_past_day', false, [], Lang::get('top10', 'torrents')), 'day', $TopTorrentsActiveLastDay, $Limit);
    }
    if ($Details == 'all' || $Details == 'week') {
        ...
        generate_torrent_table(Lang::get('top10', 'in_the_past_week', false, [], Lang::get('top10', 'torrents')), 'week', $TopTorrentsActiveLastWeek, $Limit);
    }
    ...
    if ($Details == 'all' || $Details == 'month') {
        ...
        generate_torrent_table(Lang::get('top10', 'in_the_past_month', false, [], Lang::get('top10', 'torrents')), 'month', $TopTorrentsActiveLastMonth, $Limit);
    }
    ...
    if ($Details == 'all' || $Details == 'year') {
        ...
        generate_torrent_table(Lang::get('top10', 'in_the_past_year', false, [], Lang::get('top10', 'torrents')), 'year', $TopTorrentsActiveLastYear, $Limit);
    }
    ...
    if ($Details == 'all' || $Details == 'overall') {
        ...
        generate_torrent_table(Lang::get('top10', 'most_torrents', false, [], Lang::get('top10', 'torrents')), 'overall', $TopTorrentsActiveAllTime, $Limit);
    }
    ...
    if (($Details == 'all' || $Details == 'snatched') && !$Filtered) {
        ...
        generate_torrent_table(Lang::get('top10', 'most_snatched', false, [], Lang::get('top10', 'torrents')), 'snatched', $TopTorrentsSnatched, $Limit);
    }
    ...
    if (($Details == 'all' || $Details == 'data') && !$Filtered) {
        ...
        generate_torrent_table(Lang::get('top10', 'most_data', false, [], Lang::get('top10', 'torrents')), 'data', $TopTorrentsTransferred, $Limit);
    }
    ...
    if (($Details == 'all' || $Details == 'seeded') && !$Filtered) {
        ...
        generate_torrent_table(Lang::get('top10', 'most_seed', false, [], Lang::get('top10', 'torrents')), 'seeded', $TopTorrentsSeeded, $Limit);
    }
    ?>
</div>
<?
