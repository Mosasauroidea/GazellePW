<?
$Title = t('server.wiki.browse_wiki_articles');
...
<div class="LayoutBody">
    <? if (isset($Letter)) { ?>
        ...
        <div class="BoxBody center" id="alpha_beta_switcher">
            <p><?= t('server.wiki.article_note1') ?></p>
            ...
            <!-- <br /> -->
            <p><?= t('server.wiki.article_note2') ?></p>
            <span>
        ...
        <div class="TableContainer">
            <table class="TableWikiArticle">
                <tr class="Table-rowHeader">
                    ...
                    <td class="Table-cell"><?= t('server.wiki.last_upload') ?></td>
                    <td class="Table-cell"><?= t('server.wiki.last_edited') ?></td>
                </tr>
