...
<div class="LayoutBody">
    <div class="Form-rowList" variant="header">
        <div class="Form-rowHeader">
            <div class="Form-title"><?= Lang::get('wiki.article_edit') ?></div>
        </div>
            ...
            <div class="Post-body Box-body HtmlText">
                ...
                ?>
                    <div class="Post-bodyActions" variant="alignLeft">
                        ...
                        <div><?= Lang::get('wiki.article_restrict_read') ?>:</div> <select class="Input" name="minclassread"><?= class_list($Read) ?></select>
                        <div><?= Lang::get('wiki.article_restrict_edit') ?>:</div> <select class="Input" name="minclassedit"><?= class_list($Edit) ?></select>
