    ...
    'master' => array(
        ...
        'banned' => array(
            ...
            'resolve_options' => array(
                ...
                'warn' => '4',
                'delete' => '1',
                'pm' => '[rule]h1.2[/rule]。你上传了本站目前禁止的资源。列于禁止发布列表（位于 [url=upload.php]发布页面[/url] 顶部）以及上传规则中 [url=rules.php?p=upload#1.2]特别禁止[/url] 部分的资源不能被上传到本站。除非你的种子符合禁止发布列表注释中指定的条件，否则请勿发布。
