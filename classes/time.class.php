 ...
 */
function time_diff($TimeStamp, $Levels = 2, $Span = true, $Lowercase = false, $StartTime = false, $HideAgo = false) {
    return Time::timeDiff($TimeStamp, $Levels, $Span, $Lowercase, $StartTime, $HideAgo);
}
